module.exports = {
   users:[
      {"firstName": "Getu", "lastName": "Taddesse", "password": "1234", "email": "getu@gmail.com"},
      {"firstName": "Yared", "lastName": "Gari", "password": "5678", "email": "yared@gmail.com"},
      {"firstName": "Raishan", "lastName": "Bernard", "password": "abcd", "email": "bernard@gmail.com"}
   ],
  sauces: [
  ...
  orders: [
    {"itemName": "Mens Casual Premium Slim Fit T-Shirts", "description": "Your perfect pack for everyday use and walks in the forest. Stash your laptop (up to 15 inches) in the padded sleeve, your everyday", "quantity": 3, "orderDate": "05-31-2022"},
    ...
    {"itemName": "Mens Casual Slim Fit", "description": "The color could be slightly different between on the screen and in practice. / Please note that body builds vary by person, therefore, detailed size information should be reviewed below on the product description.", "quantity": 2, "orderDate": "06-10-2022"}
  ],
